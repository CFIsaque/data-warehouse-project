...
3. **Data Modeling**: Developing fact and dimension tables optimized for analytical queries. The modeling relationship used is **many to one**. To support the analytical teams, there a **[catalog](https://github.com/CFIsaque/data-warehouse-project/blob/main/docs/data_catalog.md)** of datasets, including field descriptions and metadata.
